...
CREATE TABLE cc_system.ndc (
    ...
    strength_mg_per_unit NUMERIC(10,2),
    dosage_form VARCHAR(20),
    opioid_flag CHAR(1),
    mme_per_unit NUMERIC(10,2),
...
CREATE TABLE cc_system.claims_partd (
    ...
    days_supply INTEGER,
    total_mme NUMERIC(10,2),
    claim_amount NUMERIC(10,2),
    beneficiary_paid_amount NUMERIC(10,2),
    city VARCHAR(50),
    state CHAR(2),
    zip VARCHAR(10),
